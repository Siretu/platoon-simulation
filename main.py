...
def main():
    path_data = get_path_data_sets('./testing/testroutes/test100-1-new/')
    result = dynamic_simulation(GreedyPlatooning(), path_data_sets=path_data, folder='./testing/testroutes/test100-1-new/')
